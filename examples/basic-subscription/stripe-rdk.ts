...
const stack = new Stack(undefined, 'BasicSubscriptionStack', {
...
const basicProduct = new Product(stack, 'BasicProduct', {
  name: 'Basic Plan',
...
const proProduct = new Product(stack, 'ProProduct', {
  name: 'Pro Plan',
...
const enterpriseProduct = new Product(stack, 'EnterpriseProduct', {
...
new Price(stack, 'EnterpriseMonthly', {
...
new Coupon(stack, 'AnnualUpgrade', {
